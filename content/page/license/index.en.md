...
A list of licenses and credits for the tools provided by this service.

## Open Source Software

The following tools are based on original open source projects. We are grateful to the developers of each project.
...
- **Gephi Lite** — GPL-3.0 License (Gephi / OuestWare)
- **iwanthue** — MIT License (Sciences Po médialab)
- **JSON Crack** — Apache-2.0 License (Aykut Saraç)
- **kepler.gl** — MIT License (Urban Computing Foundation)
...
The following tools are originally developed by dataviz.jp.

- **ADS-B / AIS Visualization**
- **Aozora Bunko Ruby Remover**
...
- **GTFS Network Data Converter**
- **Lat/Lon Formatter**
- **Mapbox Classic Style Generator**
- **QuickChart UI**
